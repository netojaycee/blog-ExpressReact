  ...
  return (
    <section className="w-full relative flex flex-col rounded-3xl bg-primary text-white my-10">
      <footer className="w-full py-8  px-8">
        <div className="flex md:flex-row flex-col w-full justify-between items-center gap-x-12 bg-transparent  text-center md:justify-between">
          ...
          <div className="flex md:flex-row flex-col justify-end pt-4 mb-10 gap-[10px] w-full">
            <a href="" className="flex px-[20px] gap-2 border justify-center items-center h-fit rounded-lg shadow-inner py-2 md:text-[12px] text-[10px] bg-black text-white" role="button">
        ...
        <div className="flex flex-col md:flex-row justify-center md:justify-between">
          <div className="flex gap-4 text-white text-center justify-center sm:justify-center">
            ...
            <Typography as="a" href="https://mobile.twitter.com/mhapy_ai" className="opacity-80 transition-opacity hover:opacity-100">
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path
                  fillRule="evenodd"
